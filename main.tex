...
\section{Recent LLM Progress}

\begin{frame}{Recent LLM Progress}
  \centering
  \Large Recent LLM Progress
\end{frame}

\section{Kinds of Autoresearch}

\begin{frame}{Kinds of Autoresearch}
  \centering
  \Large Kinds of Autoresearch
\end{frame}

\section{Autoresearch Techniques}

\begin{frame}{Autoresearch Techniques}
  \centering
  \Large Autoresearch Techniques
\end{frame}
