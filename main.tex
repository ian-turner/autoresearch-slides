...
\begin{frame}{Case Study 1: The AI Scientist}
  \begin{itemize}
    \item End-to-end ML autoresearch: idea generation $\to$ experiments $\to$ paper \citep{lu2024aiscientist}
...
\begin{frame}{Case Study 3: The Virtual Lab}
  \begin{itemize}
    ...
    \item \textbf{Structure}: human PI writes meeting agendas; LLM PI agent leads specialist agents (biologist, CS, critic); critic provides feedback; PI synthesizes
...
\begin{frame}{Technical Failures}
  ...
  \end{itemize}
  \vfill
  \footnotesize\citep{llmsnotscientists2025}
\end{frame}
...
\begin{frame}{Conclusions}
  \begin{itemize}
    ...
    \item The research lifecycle is a \textbf{pipeline, not a single task}; current systems
          fail most predictably at the beginning (literature review) and end (genuine novelty)
  \end{itemize}
\end{frame}
