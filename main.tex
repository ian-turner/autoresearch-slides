...
\begin{frame}{A Spectrum of AI-Assisted Research}
  \begin{itemize}
    \item \textbf{Traditional research} \hfill human owns every step
    \item \textbf{Tool-assisted} \hfill search engines, code editors, statistics packages
    \item \textbf{AI for Science} \hfill AI solves targeted sub-tasks (AlphaFold, Copilot)
    \item \textbf{Vibe researching} \hfill human orchestrates; agents execute \citep{feng2026visionary}
    \item \textbf{Autoresearch} \hfill fully autonomous, end-to-end discovery
  \end{itemize}
\end{frame}
